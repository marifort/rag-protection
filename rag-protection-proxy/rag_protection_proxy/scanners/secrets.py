...
Regex patterns in _PATTERNS; high-severity matches (e.g. private_key at 1.0)
often push aggregate risk above block_threshold. Used in scan_input() and scan_output().
