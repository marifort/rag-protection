...
Flags cloud metadata endpoints, private/loopback IPs, denylisted hosts, and
optional allowlist violations. Does not redact URLs — findings raise risk score.

Docs: docs/guardrails/GUARDRAIL_2_DLP.md#scanner-3--url-threats-urlthreatscanner
